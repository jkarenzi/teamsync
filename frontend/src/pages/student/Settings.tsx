...
import { FaCamera, FaKey, FaUser, FaGraduationCap, FaGithub } from "react-icons/fa";
import { IoClose } from "react-icons/io5";
import { changePasswordSchema, editStudentProfileSchema } from "../../validationSchema/authSchema";
...
const Settings = () => {
    ...
    const formik = useFormik({
        ...
        validationSchema: editStudentProfileSchema
    })
                    ...
                    <div className="flex xs:flex-col lg:flex-row xs:items-center lg:items-start gap-12">
                        ...
                        <div className="flex-1 w-full">
                            ...
                            <form className="w-full flex flex-col gap-6" onSubmit={formik.handleSubmit}>
                                ...
                                <div className="flex flex-col gap-2">
                                    <label className="font-medium text-gray-700 flex items-center gap-2">
                                        <FaGraduationCap size={14} className="text-custom-blue" />
                                        Program
                                    </label>
                                    <select 
                                        className={`border ${formik.touched.program && formik.errors.program ? 'border-red-500 focus:ring-red-200' : 'border-gray-300 focus:ring-blue-100'} 
                                        outline-none rounded-lg w-full py-3 px-4 bg-gray-50 focus:bg-white
                                        transition-all duration-200 focus:ring-4 focus:border-custom-blue`}
                                ...
                                <div className="flex flex-col gap-2">
                                    <label className="font-medium text-gray-700 flex items-center gap-2">
                                        <FaGithub size={14} className="text-custom-blue" />
                                        Github Username <span className='text-sm text-custom-textGrey'>(optional)</span>
                                    </label>
                                    <input 
                                        id="githubUsername"
                                        type="text"
                                        placeholder="Enter your github username"
                                        className={`border ${formik.touched.githubUsername && formik.errors.githubUsername ? 'border-red-500 focus:ring-red-200' : 'border-gray-300 focus:ring-blue-100'} 
                                        outline-none rounded-lg w-full py-3 px-4 bg-gray-50 focus:bg-white
                                        transition-all duration-200 focus:ring-4 focus:border-custom-blue`}
